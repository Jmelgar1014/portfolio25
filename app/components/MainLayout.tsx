  ...
  return (
    <>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="fixed top-0 left-1/4 w-96 h-96 bg-purple-600/20 rounded-full blur-[128px]" />
        <div className="fixed bottom-0 right-1/4 w-96 h-96 bg-blue-600/20 rounded-full blur-[128px]" />
