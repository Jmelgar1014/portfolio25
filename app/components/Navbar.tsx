  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 flex justify-center px-4 z-50">
        <nav className="bg-slate-300/5 backdrop-blur-md border border-white/5 rounded-3xl w-full sm:w-96 my-4 shadow-lg sm:h-12 flex items-center justify-center">
